...
var onnxArrayBuffer = fs.readFileSync("./data/yolov5s_external/yolov5s.onnx")
...
model.doc_string = "the yolov5s onnx model";
...
// let modelObject = root.onnx.ModelProto.toObject(model);
